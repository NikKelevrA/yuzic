...
import { Heart, Play, Download, CloudDownload, ChevronRight } from 'lucide-react-native';
...
export const songExternalActions: ActionDef<Ctx>[] = [
  ...
  },
  {
    ...
    visible: ctx => ctx.canDownloadTrack,
